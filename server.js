...
async function fetchPinnedIssues(cfg, keys) {
  ...
  const fields = 'summary,status,assignee,issuetype,priority,customfield_10016,customfield_10028,customfield_12143,customfield_13936,customfield_14050,customfield_11969,customfield_13056,customfield_13719,created,updated';
...
function parseIssue(i, domain, statusFn = mapStatus) {
  ...
  return {
    ...
    goLivePlanejado:   (f.customfield_13936 || null),  // Planned Golive Date
